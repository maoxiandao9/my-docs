...
{% include note.html content="Why do the CSI measurements misalign with each other? Do you wanna stitch them together? You may refer to [The academic paper of PicoScenes](resources.html#the-academic-paper-of-picoscenes)." %}
